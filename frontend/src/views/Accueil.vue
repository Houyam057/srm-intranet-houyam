...
<template>
  <div class="page page-accueil show">
    ...
    <div class="card flash" style="margin-bottom:20px">
      ...
      <router-link to="/flashinfo" class="more">
        En savoir plus
    ...
    <div class="grid" style="grid-template-columns:1.6fr 1fr;margin-top:20px">
      <div class="card card-pad art-main">
        <div class="card-h">
          <h3>Actualités</h3><span class="see">Voir tout</span>
        </div>
        ...
        <div class="art-lead">
          ...
          <p>La SRM-TTA renforce sa collaboration avec les collectivités locales pour améliorer la qualité de service.
          </p>
        </div>
    ...
    <div class="grid" style="grid-template-columns:1.25fr 1fr 1fr;margin-top:20px">
      <div class="card card-pad">
        <div class="card-h">
          <h3>Notes de service</h3><span class="see">Voir tout</span>
        </div>
      ...
      <div class="card card-pad">
        ...
        <div class="svc">
          <a v-for="(s, i) in services" :key="i">
            <span class="ic"><svg viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round"
